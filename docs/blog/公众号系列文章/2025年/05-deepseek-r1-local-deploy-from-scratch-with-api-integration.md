...
![](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/DeepSeek_题图.png)
...
![ 最终效果展示](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/FG-152249-T-b611edc1915cf36afae1dd05d219afee.png)
...
![](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/FG-152233-c-5014c5ac116673cd6ead22ff820f38fd.png)

**启动模型**：下载完成后，点击 LM Studio 顶部的下拉框，选择刚刚下载好的模型，然后点击“加载模型”即可，LM Studio 会自动为你部署模型。

![](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/FG-152233-5-d0307961fa7ad2162208058379784136.png)

完成后，就可以点击左侧的聊天图标，进入对话界面了。LM Studio 提供了一个对话界面，你可以直接与 DeepSeek 对话。

![](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/FG-152233-E-a138b5da83d138750ad00da85eea251c.png)
...
![](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/FG-152233-d-7f2fa97c9b25c8ee7afd7da387415fd7.png)
...
![](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/FG-152233-T-67ff91af919ab40915ee0c7235fcc23e.png)
...
![](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/FG-152233-0-47897189fe9f925c18646f620dc1b67e.png)
...
![](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/FG-152233-J-c989f1190110a253a53c5db7ea75cfde.png)
...
![](./05-deepseek-r1-local-deploy-from-scratch-with-api-integration.assets/FG-152233-G-7b62f8843245b68f5b0b272f713f581e.png)
