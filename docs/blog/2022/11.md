...
![](./11.assets/bdb1b16c730c4e93945d9cc61a6613b2.png)
## 解决办法：

Settings --> Tools --> Terminal --> Shell Path，`将 powershell 修改为 cmd.exe`，如下图所示：

![](./11.assets/126f695841a74022b90db7f6a1ab8abf.png)

修改 shell 过后，可以看到使用的是 windows 的 cmd shell ，并且会自动跳转到虚拟环境

![](./11.assets/3a3a48dcdec94c768571dc41d04bbd6f.png)

![](./11.assets/25e21e53cba04a56885c4f84319f641b.png)
