...
# 作业 7:
![](./01.assets/7c4ee3d233f16b7350271fc29448bf1a.png)
...
![](./01.assets/ff703b450188ea3677e9ba24c96f5025.png)
...
![](./01.assets/8f3508d9080ee2231835d77c40ae024e.png)
...
# 作业 8:
![](./01.assets/2b5db7639a3f8731244a41ddfdedc4cc.png)
## 6-1 定义并实现身体质量指数类（高教社，《Python编程基础及应用》习题9-3） (4分)
按图施工，设计下述 BMI 「**Body Mass Index」**类，用于计算身体质量指数。该指数等于体重（kg) 除以身高 (米) 的平方。
![](./01.assets/03b1941a45c0160d951485cef829b55e.png)
相应的判定标准如下图所示。
![](./01.assets/3047dfd6e8a056be907e16bb83a6c954.png)
...
其中，getRoot1()返回的根对应：![](./01.assets/99abcf7d19a0f16927972aa580256371.png)
getRoot2()返回的根对应： ![](./01.assets/5cb8d280faae611ccd6049b6bdafe90d.png)
...
![image.png](./01.assets/7849df0942a74516036479ce1b0f7477.png)
...
![image.png](./01.assets/e811ca47f8d8627084afaf17ef9a5a69.png)
