...
![](./19-Big-Model-API.assets/image-20250307203410649.png)
...
![创建 API key](./19-Big-Model-API.assets/image-20250307203122693.png)

输入 API key 的名称后（为了区分不同项目使用的 key），点击创建：

![](./19-Big-Model-API.assets/image-20250307203103676.png)

点击创建后，即可复制得到的 key。

![](./19-Big-Model-API.assets/image-20250307203219297.png)
