---
title: DeepSeek Just Confirmed My Suspicions About OpenAI
date: 2025-02-03 20:12:58
author: AI悦创
isOriginal: true
icon: blog
sticky: false
...
![Image created by author using Canva](./03-DeepSeek-Just-Confirmed-My-Suspicions-About-OpenAI.assets/1*bDIs7ENsvScSQHEuauHJjg.jpeg)

There are three typical reasons why OpenAI makes the news:

1. There’s a fiasco among board members
2. They’re launching a new product
3. Or they’re whining about how they’re still not making profit

They recently made the news for reason number 3.

Early January, Sam Altman dropped this irksome tweet.

![Screenshot by author](./03-DeepSeek-Just-Confirmed-My-Suspicions-About-OpenAI.assets/1*AG7iBHBOs0yz8LGT1YovWw.jpeg)
...
But this wasn’t how things were for the biggest companies of today. These other tech giants had [fewer products when they turned profitable](https://www.theceomagazine.com/business/innovation-technology/businesses-that-make-money-right-away/):
...
Worse still, everything about space exploration is ridiculously expensive. Sending a rocket to space would typically [costs NASA close to $2 billion](https://nstxl.org/reducing-the-cost-of-space-travel-with-reusable-launch-vehicles/). The implications of this expense is two-fold:
...
Through SpaceX, Musk was able to make rocket-building significantly inexpensive. SpaceX flights could cost between [$62m - $90m](https://nstxl.org/reducing-the-cost-of-space-travel-with-reusable-launch-vehicles/) — that is more than 90% price reduction. And this has the two-fold implication of letting us send more rockets to space, and therefore speeding up space exploration.
...
The result is that, as of April 2024, SpaceX was launching [a mission every 2.7 days](https://arstechnica.com/space/2024/04/spacex-has-now-landed-more-boosters-than-most-other-rockets-ever-launch/). A number whose significance shines when you consider that from the mid 1980s through the 2010s, a mission was launched every 2.8 days, not just by NASA, but worldwide!
...
- Its performance [matches or beat](https://techcrunch.com/2025/01/26/deepseek-gets-silicon-valley-talking/)s OpenAI’s o1 model on certain AI benchmarks.
...
![Here's a look at DeepSeek doing its thing](./03-DeepSeek-Just-Confirmed-My-Suspicions-About-OpenAI.assets/1*8cYG0nY3bBPp4BuODlN68g.gif)
