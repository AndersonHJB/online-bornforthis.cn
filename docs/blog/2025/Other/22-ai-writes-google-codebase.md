...
![](./22-ai-writes-google-codebase.assets/sssss.png)
...
![AI 现在已经生成了谷歌 25% 的代码](./22-ai-writes-google-codebase.assets/llll.png)
...
![](./22-ai-writes-google-codebase.assets/jjjj.gif)
...
可没过几天，当网络出问题我不得不用手码时——我才意识到，我其实已经开始**依赖这个工具**了。
...
拜托，我们不是早就一致认为 **ChatGPT 和 DeepSeek 是爆款工具**了吗？
...
没过几天，当我不得不脱离它独立写代码时，我才意识到自己已经**严重依赖了它的“思路引导”功能**。
...
而 ChatGPT 和 DeepSeek 的本质并非“补全工具”，而是**“思维预测工具”**。
 它们正在帮助程序员**把“脑中之想”快速落地成“代码实现”**，用 Tab 键代替几十次敲击。

这仅仅是**逐行级别的体验**。而现在，我们甚至有了更进一步的工具：
...
[https://medium.com/coding-beauty/ai-writes-google-codebase-00e6ad35ac7c](https://medium.com/coding-beauty/ai-writes-google-codebase-00e6ad35ac7c)
