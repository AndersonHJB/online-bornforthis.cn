...
![](./05.assets/image-20240404225213461.png)
...
![](./05.assets/image-20240404232101603.png)

@tab Step2

![](./05.assets/image-20240404232803047.png)

@tab Step3

![私钥配置在当前仓库中(settings/secrets and variablesactions/secrets).png](./05.assets/image-20240404233002923.png)

@tab Step4

![公钥配置在目的仓库中(settings/Deploy keys).png](./05.assets/image-20240404234012438.png)

@tab Step5

![](./05.assets/image-20240404234151660.png)
