...
![](./01-原理：一个例子讲清楚Transformer原理.assets/ac37491495b36718edcd7284d6b3f2c5.jpg)
...
![](./01-原理：一个例子讲清楚Transformer原理.assets/image-20250211142805456.png)



接着是例 2，如果接着输入，GPT 就会继续翻译，不再需要额外的指令。

![](./01-原理：一个例子讲清楚Transformer原理.assets/image-20250211145708657.png)
...
![](./01-原理：一个例子讲清楚Transformer原理.assets/222.png)
