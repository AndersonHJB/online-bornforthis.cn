...
![](./s3_06.assets/2ed79940-33b5-11ea-9ca4-83fe0a60672f.png)
...
![](./s3_06.assets/cbf5ced0-33b6-11ea-8b88-8362a765a58e.png)
...
![](./s3_06.assets/a2000210-33b8-11ea-8b88-8362a765a58e.png)
...
![](./s3_06.assets/dba38890-33bb-11ea-be28-8d6dbc98de70.png)
...
![](./s3_06.assets/42403340-34da-11ea-b4c4-13dc5d89e003.png)

#### 4.1.1 建表

![](./s3_06.assets/6339d1f0-34da-11ea-9ca4-83fe0a60672f.png)

PS：如果上节课得代码出现编码问题，同学们可以添加 `charset=UTF8MB4`。

![](./s3_06.assets/9fe48550-34da-11ea-9432-5b613735c0e9.png)
...
![](./s3_06.assets/308a65c0-34db-11ea-a5b4-7d428dffd707.png)

可以知道，这样删除数据会有数据冗余，那我们该如何操作呢？

![](./s3_06.assets/8bce0b80-34db-11ea-9f17-dd0f6e540c0c.png)
...
if __name__ == '__main__':
	...
	session.commit()
```
![](./s3_06.assets/ba92da90-34db-11ea-bf2b-8d1df3c44562.png)
```python
if __name__ == '__main__':
	Session = sessionmaker(engine)
	session = Session()
...
![](./s3_06.assets/de817650-34db-11ea-8b88-8362a765a58e.png)
