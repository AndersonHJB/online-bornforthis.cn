...
![img](./s3_01.assets/Cgq2xl5on76ANrhqAAOUr7Y20R4873.png)
...
![img](./s3_01.assets/CgpOIF5on8CAb3vnAAANA7l3qLE757.png)

这里打印了 Response 对象的两个属性，一个是 text，另一个是 content。

运行结果如图所示，其中前两行是 r.text 的结果，最后一行是 r.content 的结果。

![img](./s3_01.assets/Cgq2xl5on8GARhzvAAF-fz8cGvg942.png)
...
![img](./s3_01.assets/Cgq2xl5on8GAFP1xAAADVlDCrKg987.png)
...
![img](./s3_01.assets/CgpOIF5on8SAX03uAAOB7v9rrD8925.png)
...
![img](./s3_01.assets/CgpOIF5on8SAKWukAAEoUzW61mM808.png)
...
![img](./s3_01.assets/Cgq2xl5on8WARK6YAABlizks2bg479.png)
...
![img](./s3_01.assets/CgpOIF5on8iAM1Y6AAAcAQw7Wy4460.png)
