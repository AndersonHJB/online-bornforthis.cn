---
title: 15-爬虫解析利器 PyQuery 的使用
date: 2022-12-20 16:42:05
author: AI悦创
isOriginal: true
...
更详细的安装方法可以参考：[pyquery-install](https://bornforthis.cn/column/crawler/supplement/pyquery-install.html)。
...
```python
from pyquery import PyQuery as pq
doc = pq(url='https://bornforthis.cn')
print(doc('title'))
```
...
from pyquery import PyQuery as pq
import requests
doc = pq(requests.get('https://bornforthis.cn').text)
print(doc('title'))
```
...
# li.add_class("aiyc")
# print(li)
# <li class="item-0 active aiyc"><a href="link3.html"><span class="bold">third item</span></a></li>
```
