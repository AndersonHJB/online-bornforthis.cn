...
![](https://raw.githubusercontent.com/AndersonHJB/blog-images/refs/heads/main/docs-images/sha256/29/297596d658f03a23067c6e1c28df06248d8e8d39bcc66e8953aa524fa8afc5b9.png)
...
【填空题】将下面代码补充完整，创建一个有效的 switch 语句
...
【单选题】如果我们忘记在 case 的末尾添加 break 语句，会发生什么？
    ...
    static void Main() {
        ...
        switch (light) {
            ...
            case "绿":
                ...
                break;
            case "黄":
                Console.WriteLine("黄灯请注意");
                break;
            default:
                Console.WriteLine("无效的信号灯颜色");
                break;
        }
    }
}
...
class Program {
    static void Main() {
        ...
        switch (menuNumber) {
            case 1:
                Console.WriteLine("汉堡包 - 价格：10元");
                break;
            case 2:
                Console.WriteLine("薯条 - 价格：5元");
                break;
            case 3:
                Console.WriteLine("可乐 - 价格：3元");
                break;
            default:
                Console.WriteLine("未知菜单项");
                break;
        }
    }
}
