...
![](./01-macOS入门指南.assets/osx-el-capitan-setup-macbook-gold-open.png)
...
| 图标                                                         | 应用程序      | 描述                                                         |
| ------------------------------------------------------------ | ------------- | ------------------------------------------------------------ |
| ![“App Store”图标](./01-macOS入门指南.assets/image-20230416071519306.png) | App Store     | 查找、购买、安装和更新适用于 Mac 的应用程序，请参阅[《App Store 使用手册》](https://support.apple.com/zh-cn/guide/app-store)。 |
| ![“计算器”图标](./01-macOS入门指南.assets/image-20230416071743081.png) | 计算器        | 执行基本计算、高级计算或编程器计算。请参阅[《计算器使用手册》](https://support.apple.com/zh-cn/guide/calculator)。 |
| ![“日历”图标](./01-macOS入门指南.assets/image-20230416071814532.png) | 日历          | 日历软件，制定并跟踪会议、日程和约会。请参阅[《日历使用手册》](https://support.apple.com/zh-cn/guide/calendar)。 |
| ![“提醒事项”图标](./01-macOS入门指南.assets/image-20230416071833690.png) | 提醒事项      | 为待办事项、项目、购物和其他任何需要跟踪的事项创建列表。请参阅[《提醒事项使用手册》](https://support.apple.com/zh-cn/guide/reminders)。 |
| ![“Keynote 讲演”图标](./01-macOS入门指南.assets/image-20230416071855730.png) | Keynote 讲演  | 类似于 PPT，使用图像、媒体、图表、动画等创建演示文稿。请参阅[《Keynote 讲演使用手册》](https://support.apple.com/zh-cn/guide/keynote)。 |
...
![](./01-macOS入门指南.assets/image-20230416072224569.png)

在桌面的左上角，苹果标志  右侧，就是「日历」的菜单栏选项。在这里可以对「日历」进行一些设置操作。

![](./01-macOS入门指南.assets/image-20230416072247172.png)

软件的相关设置，大多都可以在软件的「菜单栏选项」中的「系统设置」里边进行设置，如下图所示。

![](./01-macOS入门指南.assets/image-20230416072331614.png)
...
> 注：关于 Mac 有哪些好用的软件，具体可以看我写的这篇文章： [**04 - macOS 软件清单**](/column/macOS-Tips/04-macOS软件清单.md)。
