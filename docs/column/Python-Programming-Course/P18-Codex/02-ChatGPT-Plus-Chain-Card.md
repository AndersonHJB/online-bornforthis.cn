...
![用国内银行卡订阅 ChatGPT Plus](./02-ChatGPT-Plus-Chain-Card.assets/cover-faithful.png)
...
![国内银行卡通过 Google Play 订阅 ChatGPT Plus 的付款链路](./02-ChatGPT-Plus-Chain-Card.assets/image-20260717192033142.png)
...
![Clash Verge 的 AI 服务解锁测试](./02-ChatGPT-Plus-Chain-Card.assets/image-20260717191408633.png)
...
![ChatGPT 登录或注册入口](./02-ChatGPT-Plus-Chain-Card.assets/image-20260717192601670.png)
...
![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260717215307746.png)
...
![ChatGPT 网页端付款方式验证失败](./02-ChatGPT-Plus-Chain-Card.assets/image-20260717194011418.png)
...
![中国区是看不见 GPT 这类软件的](./02-ChatGPT-Plus-Chain-Card.assets/image-20260718073311806.png)
...
<img src="./02-ChatGPT-Plus-Chain-Card.assets/image-20260718080100543.png" style="zoom:25%;" />

如果这个账号从未建立过付款资料，这里可能还是空的；如果已经有其他国家或地区的付款资料，会显示现有资料。

![Google Play 美区由 IP 和支付资料共同决定](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719155210843.png)
...
![Google Payments 中新建美国付款资料](./02-ChatGPT-Plus-Chain-Card.assets/04-google-payments-us-profile-entry.jpg)

*已有资料的国家/地区不能直接改时，选择“新建个人资料”，国家/地区选美国（US）。*

在国家或地区下拉菜单中选择：**美国（US）**。

![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719204049055.png)

![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719204009178.png)
...
![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719214222314.png)
...
![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719193333712.png)
...
![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719214513984.png)

![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719215346468.png)

![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719215416412.png)

![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719215609212.png)

![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719215703201.png)



如果页面显示“美国”，说明当前 Google Play 已经按美区资料工作。

![Google Play 美区方案示意](./02-ChatGPT-Plus-Chain-Card.assets/image-20260718075958742.png)
...
![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719220303218.png)

进入 Google 付款中心：**支付方式 → 添加支付方式 → 添加信用卡或借记卡**。

![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719220432335.png)



![Google Payments 添加信用卡或借记卡](./02-ChatGPT-Plus-Chain-Card.assets/04a-google-payments-add-card-form.jpg)
...
![Google Play 对国际卡和 62 银联卡的兼容性对比](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719220832159.png)
...
![国内可尝试的 Visa 或 Mastercard 单标信用卡&招商银行万事达人民币 IC 借记卡普卡](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719221141625.png)
...
![招商银行万事达人民币 IC 借记卡普卡](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719221551398.png)
...
![](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719221743895.png)

如果名下有多张招行储蓄卡，页面可能默认选中了普通银联卡。此时要先切换到新办的万事达人民币借记卡，“万事达卡跨境线上支付”选项才会出现。

<img src="./02-ChatGPT-Plus-Chain-Card.assets/image-20260719221839276.png" alt="招商银行 App 切换到目标万事达借记卡" style="zoom:25%;" />

*名下有多张储蓄卡时，先切到新办的万事达人民币借记卡。*

![招商银行 App 中的万事达卡跨境线上支付入口](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719221906747.png)
...
![Google Payments 银行卡信息填写表单](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223026697.png)
...
![Google 付款方式中已经出现 Mastercard](./02-ChatGPT-Plus-Chain-Card.assets/10-google-play-mastercard-added.jpg)
...
![Google Play 中由 OpenAI 发布的 ChatGPT 应用](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223125029.png)

*核对应用名和发布者 OpenAI 后再安装。*

安装完成后打开 ChatGPT，使用前面准备好的 ChatGPT 账号登录。推荐继续使用同一个 Google 账号一键登录，避免误入另一个账号。

<img src="./02-ChatGPT-Plus-Chain-Card.assets/11a-chatgpt-google-login.jpg" alt="ChatGPT Android 登录页" style="zoom:25%;" />
...
![ChatGPT 主界面的获取 Plus 入口](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223250789.png)

*进入 App 后点击左上方“获取 Plus”。*

![ChatGPT Plus 套餐页](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223312411.png)
...
![Google Play ChatGPT Plus 订阅确认页](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223345530.png)

*本次页面显示 US$19.99/月，并写明税费和续订日前预授权说明。*

![招商银行 135.06 元境外消费预授权](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223427403.png)
...
<img src="./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223524014.png" alt="ChatGPT App 付款后的模型与思考强度选择器" style="zoom:25%;" />

*模型名称会更新，重点是账号已经出现 Plus 对应的模型与思考强度选项。*

![ChatGPT App 中 Plus 显示为当前套餐](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223547958.png)
...
![ChatGPT 网页端模型选择器](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223720299.png)

*回到网页端，用同一个账号核对模型和思考强度。*

![ChatGPT 网页端账单显示 Plus 和自动续订日期](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719223918955.png)
...
![Codex 模型与思考强度选择器](./02-ChatGPT-Plus-Chain-Card.assets/16a-codex-model-selector.jpg)

*Codex 中可查看当前开放的模型与思考强度。*

![Codex 使用情况和计费显示 Plus](./02-ChatGPT-Plus-Chain-Card.assets/image-20260719224139900.png)
...
![ChatGPT 订阅需要在 Google Play 中管理](./02-ChatGPT-Plus-Chain-Card.assets/17-manage-subscription-in-google-play.jpg)
