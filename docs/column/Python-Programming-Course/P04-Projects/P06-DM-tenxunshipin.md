...
![](./P06-DM-tenxunshipin.assets/image-20251026112446005.png)
...
- 鼠标操作 1：鼠标右键检查；
    ...
    ![](./P06-DM-tenxunshipin.assets/image-20251026113047724.png)
...
- 鼠标操作 2：
    ...
    ![](./P06-DM-tenxunshipin.assets/image-20251026113242856.png)

    :::

### 1.3 分析弹幕 URL

![](./P06-DM-tenxunshipin.assets/image-20251026113650980.png)
...
![链接存在，且请求成功则可以返回状态码 200](./P06-DM-tenxunshipin.assets/image-20251103204406008.png)

链接不存在，请求失败显示的状态码 404：

![链接不存在，请求失败显示的状态码 404](./P06-DM-tenxunshipin.assets/image-20251103204244990.png)
...
![状态码 200，但是没有弹幕数据](./P06-DM-tenxunshipin.assets/image-20251103204907046.png)
...
![](./P06-DM-tenxunshipin.assets/image-20251110201312602.png)
...
4. 修改 main 函数代码适配
    ...
    ![](./P06-DM-tenxunshipin.assets/image-20251116120106418.png)
...
![](./P06-DM-tenxunshipin.assets/db3971680ae832a6dc06c4263b34f475.png)
