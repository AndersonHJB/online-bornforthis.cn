...
![](./01-yuanzifu-zhengze-jichu.assets/63f73ac9f275c6727306fe4ba9078bd4.jpg)
...
![](./01-yuanzifu-zhengze-jichu.assets/54a184548d369ca04ad4b69cd15dac1b.png)

那你可能会好奇，正则是如何完成这些工作的呢？让我们先从简单的字符串查找和替换讲起。

我相信你一定在办公软件，比如 Word、Excel 中用过这个功能。你可以使用查找功能快速定位关注的内容，然后使用替换，批量更改这些内容。

![](./01-yuanzifu-zhengze-jichu.assets/682df773ff276084ca4f934af53fa233.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/c54ddfaa8a56453afed49f31022a8df6.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/3af8dd848b2d625db7831aa8adcd6fab.png)

如果我们在后面再加上量词，就可以表示单个的数字出现了几次。比如 `\d{11}` 表示单个数字出现 11 次，即 11 位数字，如果文本中只有姓名和手机号，我们就可以利用这个查找出文本中的手机号了，如下图所示。

![](./01-yuanzifu-zhengze-jichu.assets/5a0ce54804cc08eb3622f418c3af45bd.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/97f9aa05196ecba15a433e6e517093bb.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/199562249878c0967dde9f23c0b4904b.png)

现在我们来看一下测试，我把常见数字，字母，部分标点符号作为文本，用 `\d` 去查找，可以看到只能匹配上 10 个数字。

![](./01-yuanzifu-zhengze-jichu.assets/1380b43ba8a8ebf4a307a5d0a4e35aa5.png)

这是元字符 `\d` 测试用例的链接，你不妨测试一下：[https://regex101.com/r/PnzZ4k/1](https://regex101.com/r/PnzZ4k/1)

元字符 `\w` 能匹配所有的数字、字母和下划线，如下图所示：

![](./01-yuanzifu-zhengze-jichu.assets/60041ca73688567b0bae04950f8be0f1.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/01b6c8de6ee6c440471c15f96d00d466.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/2b03098dcc203c648a40f89a0ba77fc3.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/f0696d3fbc55c5a75832472e227a614e.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/84625cc80a90dba2c629282e3f213622.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/22b3ef8c95b01adddebad77fed106a3d.png)
...
![](./01-yuanzifu-zhengze-jichu.assets/ffd9cd49a79599e7efa4aba069faee52-20250928073852797.png)
