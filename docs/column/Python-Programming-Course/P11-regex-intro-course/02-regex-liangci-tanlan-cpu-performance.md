...
![](./02-regex-liangci-tanlan-cpu-performance.assets/8a7c66b3f05b67a1c4135ce26656be9a.jpg)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/2b03098dcc203c648a40f89a0ba77fc3-20250928122440131.png)

在这 6 种元字符中，我们可以用 `{m,n}` 来表示 （`*`）（`+`）（`?`） 这 3 种元字符：

![](./02-regex-liangci-tanlan-cpu-performance.assets/38ceb28add7794fe9ed069e08fb1b374.jpg)

表示量词的星号（`*`）和 加号（`+`）可能没你想象的那么简单，我用一个例子给你讲解一下。我们先看一下加号（`+`），使用 `a+` 在 `aaabb` 中查找，可以看到只有一个输出结果：

![](./02-regex-liangci-tanlan-cpu-performance.assets/2b3e3f549e69fdd398c15d6b0bd44e08.png)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/b0c582cbf8ec081bc798296b5471804c.png)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/63e5c750b66f6eb914c73befdba43f97.jpg)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/10e40baa1194b17dcc57a089524a37bc.png)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/3f95a3648980c1eb3c550fb34b46fad1.png)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/40c03d7a2cb990b35e4801589eca1379.png)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/7a9636b588963e5af9619837fe5a6888.png)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/2177c740a2d5dd805f3157d54636500c.png)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/96635e198c2ff6cf7b8ea2a0d18f8ecb.png)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/1dbf7d9fed42390edb3bf9ef9e0da7b7.jpg)
...
![](./02-regex-liangci-tanlan-cpu-performance.assets/1ad3eb0d011ba4fc972b9e5191a9f275-20250929081122930.png)
