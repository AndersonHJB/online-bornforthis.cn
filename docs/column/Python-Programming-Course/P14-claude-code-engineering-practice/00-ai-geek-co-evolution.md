...
![](./00-ai-geek-co-evolution.assets/7fac22fc1051d68502bfb3eec6d1be49.png)
...
![悦创和AI的协作与共生](./00-ai-geek-co-evolution.assets/1.webp)
...
![](./00-ai-geek-co-evolution.assets/2.webp)

![](./00-ai-geek-co-evolution.assets/3.webp)
...
![多个AI Coder可以混合使用，图中的使用Copilot\Claude Code\Augment共同分析一个代码库](./00-ai-geek-co-evolution.assets/4.webp)
...
![](./00-ai-geek-co-evolution.assets/5.webp)
...
![Claude Code让Sub-Agents通过一个配置文件开箱即用](./00-ai-geek-co-evolution.assets/6.webp)
...
![Skill让 AI 从“执行命令”升级为“理解意图”](./00-ai-geek-co-evolution.assets/7.webp)

更有意思的是，Skills 的**渐进式披露架构**——不是把所有知识一股脑灌给 AI，而是按需加载，用到什么加载什么。这解决了 LLM 上下文窗口的根本限制。

![](./00-ai-geek-co-evolution.assets/8.webp)
...
![](./00-ai-geek-co-evolution.assets/9.webp)

![](./00-ai-geek-co-evolution.assets/10.webp)

![AI Coder零基础即可入门，安装后直接对话即可](./00-ai-geek-co-evolution.assets/11.webp)
...
![](./00-ai-geek-co-evolution.assets/12.jpg)
...
![](./00-ai-geek-co-evolution.assets/13.webp)
...
![课程安排](./00-ai-geek-co-evolution.assets/14.webp)
...
![](./00-ai-geek-co-evolution.assets/15.webp)



![](./00-ai-geek-co-evolution.assets/16.webp)
