...
![](./14-class.assets/image-20250405224206376.png)
...
![](./14-class.assets/image-20250406212857645.png)
...
![](./14-class.assets/image-20250911205521746.png)
...
![](./14-class.assets/image-20250922145919416.png)
...
![](./14-class.assets/deepseek_r1_multiround_example_cn.png)
...
3. 一句话说明游戏规则以及玩法：（**准备 DeepSeek 的提示词**）
    ...
    ![](./14-class.assets/image-20251027143703232.png)

    ![](./14-class.assets/image-20251027143714580.png)

    ![](./14-class.assets/image-20251027143725674.png)
...
client = OpenAI(
    api_key=os.getenv("DEEPSEEK_API_KEY", "sk-cd6890b8ac624127af85f7094d7c534d"),  # 不硬编码，提升安全性
...
> client = OpenAI(           # 【新增】
>     api_key="sk-cd6890b8ac624127af85f7094d7c534d", 
>     base_url="https://api.deepseek.com"
> )
> messages = []  # 【新增】用于存储上下文
> 
...
4. **局域网使用大模型**：
    ...
    **设置局域网 IP：**
    ...
    ![自己按图片的去配置即可！](./14-class.assets/image-20251120145039400.png)

    ![](./14-class.assets/image-20251120144924917.png)
