---
title: Why Can’t Robots Click The “I’m Not a Robot” Box On Websites?
...
![(OpenAI)](./why-cant-robots-click-the-i-m-not-a-robot-box-on-websites.assets/1*eaMr0gx6U7b0Cdo_q43V-w.jpeg)
...
CAPTCHA stands for **C**ompletely **A**utomated **P**ublic **T**uring test to tell **C**omputers and **H**umans **A**part. That is a mouthful, but it is also incredibly straightforward in describing what these silly boxes are meant to do. They are meant to administer automated public Turing Tests.
...
If you click too quickly, you could be asked to go through one of those visual puzzles. The new visual puzzles are a direct evolution of the original blurry text. [Cloudflare says](https://www.cloudflare.com/learning/bots/how-captchas-work/) that even the most advanced AI currently still struggles to pick out specific objects from a cluttered or blurry image. Humans do not have such problems. Being asked to decipher between blurry pictures of bicycles, mopeds, and motorcycles is a test that AI currently struggles to pass.
...
You can read about the system in Google’s own words [here](https://cloud.google.com/blog/products/identity-security/recaptcha-enterprise-protects-users-and-is-frictionless).
...
![](./why-cant-robots-click-the-i-m-not-a-robot-box-on-websites.assets/1*4AnK9mfzD_r39fCr43qJNg.png)
