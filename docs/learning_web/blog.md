---
title: Looks like a good blog
date: 2022-12-17 12:38:20
author: AI悦创
isOriginal: true
category: 
    - 我收集的网站
...
| 序号 | 名称     | 作用                    | 链接                                                         |
| ---- | -------- | ----------------------- | ------------------------------------------------------------ |
| 01   | setup.py | Python 开发库需要的模版 | [https://github.com/navdeep-G/setup.py](https://github.com/navdeep-G/setup.py) |

## VPN

1. [https://glados.rocks/](https://glados.rocks/)
