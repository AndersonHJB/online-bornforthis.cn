...
actions:
  - text: Idea💡
    link: /1v1/28-GaoTianQi/01-W00-Worksheet-0-Building-blocks.html
    type: primary	
...
This subject teaches students with little or no background in computer programming how to design and write small programs in Python, and to solve simple problems.
...
This subject is the first subject in the Computing & Software Systems and Data Science majors, and introduces students to programming and the basics of algorithmic thinking.
