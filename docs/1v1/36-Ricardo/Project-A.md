...
You will decide on the topic for your project. You should choose a business for example, a café.
...
4. **Main.java** 的代码可以保持不变，因为该类中并没有直接使用到 `ArrayList`。
