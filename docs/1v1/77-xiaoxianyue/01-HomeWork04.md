---
title: Research and case analysis of specific tasks in deep learning applications
date: 2023-11-24 21:57:58
author: AI悦创
isOriginal: true
icon: python
sticky: false
...
1. Report document: Each student shall submit a report document containing the above content (can be in Word or PDF format)
2. PPT report: The team leader prepares a 10-minute PPT report for presentation in class and submits the report document.

**Grading:**

1. Case study (50%): completeness of the case and accurate description of the case analysis.
2. Report document quality (50%): degree of condensation, division of labor, organizational structure, expression ability, time control, etc.
