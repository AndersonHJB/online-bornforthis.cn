---
title: Math 1MP3 * Assignment 1
icon: python
date: 2023-10-08 20:36:08
author: AI悦创
isOriginal: true
sticky: false
star: false
...
3. [1] A 3 × 3 matrix M is given as a list with three elements, each of which is one row in M. In other words, `M=[[1,2,3],[4,5,6],[7,8,9]]`
