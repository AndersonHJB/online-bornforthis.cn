---
title: 03-HW - Keep working on your midterm sites
icon: web
date: 2023-03-02 10:07:55
author: AI悦创
isOriginal: true
category: 
    - web 1v1
...
> 记住，上课前一小时我有空。如果你有问题，我随时奉陪。发邮件并安排时间的人将优先于亲自进来。
...
> Web开发是不断变化的。在学习新技能的过程中，你需要阅读大量的文档，并遵循教程和示例。下面是一些更复杂的CSS应用程序的标准教程链接:
...
> 如果您想探索将无序链接列表“ul li a”转换为导航栏的各种方法，[查看W3 Schools的这些教程](https://www.w3schools.com/css/css_navbar.asp)

If you want a pure CSS slider, [check out this tutorial](https://www.smashingmagazine.com/2012/04/pure-css3-cycling-slideshow/).

> 如果你想要一个纯CSS滑块，[查看本教程](https://www.smashingmagazine.com/2012/04/pure-css3-cycling-slideshow/)。
...
> 如果你正在寻找一个可折叠的手风琴，[查看W3学校教程](http://www.w3schools.com/howto/howto_js_accordion.asp)。(这个例子比纯CSS版本更简单。但是，它确实使用了少量的JavaScript。)

If you want a tooltip, [check out this W3 schools tutorial](http://www.w3schools.com/howto/howto_css_tooltip.asp).

> 如果你想要一个工具提示，[查看W3学校教程](http://www.w3schools.com/howto/howto_css_tooltip.asp)。

If you want a pure CSS popup window, check this weeks in class example!

> 如果你想要一个纯CSS弹出窗口，检查这周在课堂上的例子!
