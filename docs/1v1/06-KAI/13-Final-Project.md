...
Create a mood board using online tools such as [Miro](https://miro.com/app/dashboard/), [Pinterest](https://www.pinterest.com/) or desktop applications like Photoshop or Keynote. The mood board should be used with your website description to dictate the visual direction of your website. Consider things like color, type treatments, photographic style and design themes that you feel will be applicable to the website you will make.
...
- There should be semantic text elements on each page, including but not limited to paragraphs () and heading ( , etc.) text.
...
- Pay close attention to your HTML tags as you code them. You can also check your HTML code using the [W3C Markup Validation Service](https://validator.w3.org/).
...
[https://axure.userxper.com/axure-rp-for-school/](https://axure.userxper.com/axure-rp-for-school/)
...
- 元神：[https://genshin.hoyoverse.com/en/](https://genshin.hoyoverse.com/en/)
- AI悦创：[https://bornforthis.cn/](https://bornforthis.cn/)
- ubisoft：[https://www.ubisoft.com/en-us/game/rainbow-six/siege](https://www.ubisoft.com/en-us/game/rainbow-six/siege)
